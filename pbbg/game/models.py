...
class Entities(models.Model):
    ...
    equipment = models.ForeignKey(
        Equipment, on_delete=models.CASCADE, default=None, blank=True, null=True
    )
...
class Player(models.Model):
    ...
    def __str__(self):
        # TODO: This string representation is broken because of nested relationships in the model.
...
class InventoryItems(models.Model):
    ...
    def __str__(self):
        return (
            f"{self.resource_type.name}, quantity {self.quantity}, in {self.inventory}"
        )
